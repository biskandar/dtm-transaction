...
public class ScriptRandomCodeExec {
  ...
  static final DLogContext lctx = new SimpleContext( "ScriptRandomCodeExec" );
  ...
  public ScriptRandomCodeExec( String headerLog , String scriptSource ) {
    initialized = false;
  ...
  public boolean execute( ScriptRandomCodeData data ) {
    ...
    try {
      ...
      scriptScope.put( "code" , scriptScope , data );

      // execute the script
      int lineNo = 1;
      Object securityDomain = null;
      scriptContext.evaluateString( scriptScope , scriptSource ,
          "ScriptRandomCodeExec" , lineNo , securityDomain );
